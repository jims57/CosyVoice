...
python combine_all_pcms_into_a_pcm.py --input-sample-rate 24000 --output-sample-rate 16000
...
python convert_pcm_to_mp3_chunks_by_silence.py --pcm-file pcm/pcm_chunks_combined.pcm  --volume-dB -40.0 --min-samples-window 960  --input-pcm-sample-rate 24000 --output-mp3-sample-rate 16000
