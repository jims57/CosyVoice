...
async def generate_audio_chunks_ws(text, request_start_time, audio_format, websocket, before_inference_time):
    ...
    try:
        ...
        for chunk_idx, text_chunk in enumerate(normalized_text_chunks):
            ...
            for i, j in enumerate(global_cosyvoice.inference_zero_shot(
                ...
                if not first_chunk_sent:
                    ...
                    elapsed_since_start = (first_chunk_sent_time - request_start_time) * 1000
        ...
        elapsed_since_start = (after_inference_time - request_start_time) * 1000
...
async def websocket_tts(websocket: WebSocket):
    ...
    try:
        while True:
            ...
            try:
                # Generate and stream audio chunks directly
                await generate_audio_chunks_ws(text, start_time, audio_format, websocket, before_inference_time)
